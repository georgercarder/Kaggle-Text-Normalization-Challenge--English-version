...
##classify routine 10.18
# put off "-" & ":" till later

print("initializing...")
tst$Classs<-rep("",nrow(tst))
print("...............")
...
moneysymbols<-uniclassque(gsub(" |million|MILLION|billion|BILLION|trillion|TRILLION|\\.|,|[0-9]","",trn$before[trn$class=="MONEY"]))
...
tst$Classs[tst$Classs==""&tst$before!="-"&tst$before!=":"&tst$probdatevectT==1&grepl("^[ 012][0-9]{3}$",tst$before)]="DATE"
...
tst$Classs[tst$romanguessT!=""]=tst$romanguessT[tst$romanguessT!=""]
tst$Classs[tst$romanguessFT!=""]=tst$romanguessFT[tst$romanguessFT!=""]
tst$Classs[tst$romanguessIFT!=""]=tst$romanguessIFT[tst$romanguessIFT!=""]
tst$Classs[tst$romanguessXT!=""]=tst$romanguessXT[tst$romanguessXT!=""]
tst$Classs[tst$romanguessXFT!=""]=tst$romanguessXFT[tst$romanguessXFT!=""]
...
print("note: now our accuracy est is skewed in that")
print("the classes associated with tokens in verbatim")
print("do not necessarily match up, but we do get our")
print("desired before/after combinations")
print("Here is our skewed accuracy estimate......")
...
tst$Classs[tst$intguessT!=""]=tst$intguessT[tst$intguessT!=""]
tst$Classs[tst$intguessFT!=""]=tst$intguessFT[tst$intguessFT!=""]
tst$Classs[tst$intguess0T!=""]=tst$intguess0T[tst$intguess0T!=""]
tst$Classs[tst$intguess0FT!=""]=tst$intguess0FT[tst$intguess0FT!=""]
...
print("hence the drop in 'accuracy'")
...
save(Classs,file="Classs.classify2TEST")


Classs1<-Classs
save(Classs1,file="Classs1.classify2TEST")



print("now is the time to analyze the unclassified tokens")
print("hopefully they are only of the class, PLAIN")
#######################
#######################

#experimenting with classifying remainder of tokens
#load dictionaries
...
tst$Classs[tst$before %in% plaindictionary.diff]="PLAIN"
tst$Classs[tst$before %in% lettersdictionary.diff]="LETTERS"
tst$Classs[tst$before %in% intersectdictionary]="PLAIN"

############at this point findplainletters
